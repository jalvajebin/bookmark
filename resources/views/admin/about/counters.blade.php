                    ...
                    <form class="counterFormSubmit" id="counterFormSubmit">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input id="count1" name="count1" type="text" class="form-control count1"
                                        placeholder="Count 1" value="{{ $counter->count1 ?? '' }}">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="logo-wrapper">
                                    <img alt="Logo"
                                        src="{{ $counter->count1Image->url ?? asset('admin/images/no-image.png') }}"
                                ...
                                <div class="mb-4 mt-3">
                                    ...
                                    <input id="counter_1_alt" name="counter_1_alt" type="text" class="form-control"
                                        value="{{ $counter->counter_1_alt ?? '' }}" placeholder="Enter alt">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input id="count2" name="count2" type="text" class="form-control count2"
                                        placeholder="Count 2" value="{{ $counter->count2 ?? '' }}">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="logo-wrapper">
                                    <img alt="Logo"
                                        src="{{ $counter->count2Image->url ?? asset('admin/images/no-image.png') }}"
                                ...
                                <div class="mb-4 mt-3">
                                    ...
                                    <input id="counter_2_alt" name="counter_2_alt" type="text" class="form-control"
                                        value="{{ $counter->counter_2_alt ?? '' }}" placeholder="Enter alt">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input id="count3" name="count3" type="text" class="form-control count3"
                                        placeholder="Count 3" value="{{ $counter->count3 ?? '' }}">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="logo-wrapper">
                                    <img alt="Logo"
                                        src="{{ $counter->count3Image->url ?? asset('admin/images/no-image.png') }}"
                                ...
                                <div class="mb-4 mt-3">
                                    ...
                                    <input id="counter_3_alt" name="counter_3_alt" type="text" class="form-control"
                                        value="{{ $counter->counter_3_alt ?? '' }}" placeholder="Enter alt">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input id="count4" name="count4" type="text" class="form-control count4"
                                        placeholder="Count 4" value="{{ $counter->count4 ?? '' }}">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="logo-wrapper">
                                    <img alt="Logo"
                                        src="{{ $counter->count4Image->url ?? asset('admin/images/no-image.png') }}"
                                ...
                                <div class="mb-4 mt-4">
                                    ...
                                    <input id="counter_4_alt" name="counter_4_alt" type="text" class="form-control"
                                        value="{{ $counter->counter_4_alt ?? '' }}" placeholder="Enter alt">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input id="count5" name="count5" type="text" class="form-control count"
                                        placeholder="Count 5" value="{{ $counter->count5 ?? '' }}">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input id="count6" name="count6" type="text" class="form-control count"
                                        placeholder="Count 6" value="{{ $counter->count6 ?? '' }}">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input id="count7" name="count7" type="text" class="form-control count"
                                        placeholder="Count 7" value="{{ $counter->count7 ?? '' }}">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input id="count8" name="count8" type="text" class="form-control count"
                                        placeholder="Count 8" value="{{ $counter->count8 ?? '' }}">
