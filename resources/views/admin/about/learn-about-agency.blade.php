                            ...
                            <div class="col-sm-6 col-md-6 col-6">
                                ...
                                <div class="logo-wrapper mb-3">
                                    <img alt="EmployeeImage"
                                        ...
                                        class="logo-image avatar-md img-thumbnail EmployeeImagePreview" id="EmployeeImagePreview"
                                ...
                                <input type="file" id="employee_image" name="employee_image" class="file-input" accept="image/*"
                                    onchange="employeePreviewImage1(event)">
                        ...
                        <div class="col-sm-6 col-md-6 col-6">
                            ...
                            <div class="logo-wrapper mb-3">
                                <img alt="EmployerImage"
                                    ...
                                    class="logo-image avatar-md img-thumbnail employerImagePreview" id="employerImagePreview"
                                    style="object-fit: contain;">
                            ...
                            <input type="file" id="employer_image" name="employer_image" class="file-input" accept="image/*"
                                onchange="employerPreviewImage1(event)">
