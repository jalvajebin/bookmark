                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input id="heading" name="heading" type="text" class="form-control heading"
                                        placeholder="Heading" value="{{ $learnAboutUs->heading ?? '' }}">
                            ...
                            {{-- <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input id="button_title" name="button_title" type="text"
                                        class="form-control button_title" placeholder="Button Title"
                                        value="{{ $learnAboutUs->button_title ?? '' }}">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input id="button_link" name="button_link" type="text"
                                        class="form-control button_link" placeholder="Button Link"
                            ...
                            <div class="col-sm-6 col-md-6 col-6">
                                ...
                                <div class="logo-wrapper mb-3">
                                    <img alt="EmployeeImage"
                                        src="{{ $learnAboutUs->employee_image_name->url ?? asset('admin/images/no-image.png') }}"
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input id="employee_alt" name="employee_alt" type="text" class="form-control"
                                        value="{{ $learnAboutUs->employee_alt ?? '' }}" placeholder="Enter alt">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input id="employee_content_1" name="employee_content_1" type="text"
                                        ...
                                        value="{{ $learnAboutUs->employee_content_1 ?? '' }}">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input id="employee_content_2" name="employee_content_2" type="text"
                                        ...
                                        value="{{ $learnAboutUs->employee_content_2 ?? '' }}">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input id="employee_content_3" name="employee_content_3" type="text"
                                        ...
                                        value="{{ $learnAboutUs->employee_content_3 ?? '' }}">
                            ...
                            <div class="col-sm-6 col-md-6 col-6">
                                ...
                                <div class="logo-wrapper mb-3">
                                    <img alt="EmployerImage"
                                        src="{{ $learnAboutUs->employer_image_name->url ?? asset('admin/images/no-image.png') }}"
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <textarea id="employer_description" name="employer_description" rows="5"
                                        class="form-control employer_description" placeholder="Enter Employer Description">{{ $learnAboutUs->employer_description ?? '' }}</textarea>
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input id="employer_alt" name="employer_alt" type="text" class="form-control"
                                        value="{{ $learnAboutUs->employer_alt ?? '' }}" placeholder="Enter alt">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input id="employer_content_1" name="employer_content_1" type="text"
                                        ...
                                        value="{{ $learnAboutUs->employer_content_1 ?? '' }}">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input id="employer_content_2" name="employer_content_2" type="text"
                                        ...
                                        value="{{ $learnAboutUs->employer_content_2 ?? '' }}">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input id="employer_content_3" name="employer_content_3" type="text"
                                        ...
                                        value="{{ $learnAboutUs->employer_content_3 ?? '' }}">
