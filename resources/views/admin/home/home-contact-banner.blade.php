                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="mb-4">
                                    ...
                                    <textarea id="contact_description" name="contact_description" rows="5" class="form-control contact_description"
                                        placeholder="Enter Description">{{ optional($contactBanner)->description }}
                                    </textarea>
                            ...
                            <div class="col-sm-12 col-12">
                                ...
                                <div class="logo-wrapper">
                                    <img alt="Logo"
                                        src="{{ $contactBanner->images->preview ?? asset('admin/images/no-image.png') }}"
                                ...
                                <div class="mb-4 mt-3">
                                    ...
                                    <input name="contact_alt" type="text" value="{{ $contactBanner->alt ?? '' }}"
