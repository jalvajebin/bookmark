    ...
    function dataTable() {
        $(function() {
            datatable = $('#cvTable').DataTable({
                ...
                searching: true,
                ajax: {
                    url: '<?php echo e(route('get.cv-appliaction')); ?>',
                    type: "get",
                    data: function(d) {
    ...
    function dataTable1() {
        $(function() {
            datatable = $('#postVacancyTable').DataTable({
                ...
                searching: true,
                ajax: {
                    url: '<?php echo e(route('get.vacancy-appliaction')); ?>',
                    type: "get",
                    data: function(d) {
...
<?php /**PATH /Users/jal/Herd/bookmark/resources/views/admin/cv/js/datatable.blade.php ENDPATH**/ ?>