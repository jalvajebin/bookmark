...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('assets/images/flat-fav.png')); ?>">
    ...
    <link href="<?php echo e(asset('admin/assets/css/mainstyle.css')); ?>" id="app-style" rel="stylesheet" type="text/css" />
    <!--loader CSS -->
    ...
    <!-- -------------------------------cs date time picker-------------------------------------->
    <link href="<?php echo e(asset('admin/assets/css/bootstrap-datetimepicker.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('admin/assets/css/bootstrap-timepicker.min.css')); ?>" rel="stylesheet">
...
<body data-sidebar="dark" data-layout-mode="light">
    ...
    <script src="<?php echo e(asset('admin//assets/js/bootstrap-timepicker.js')); ?>"></script>

    <script src="<?php echo e(asset('admin/assets/libs/select2/js/select2.min.js')); ?>"></script>
...
<?php /**PATH /Users/jal/Herd/bookmark/resources/views/admin/layout/app.blade.php ENDPATH**/ ?>