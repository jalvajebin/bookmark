<script>
    ...
    $('#aboutUsFormSubmit').submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('admin.about-us.add')); ?>",
            data: formData,
            cache: false,
            contentType: false,
            processData: false,
    ...
    $('#learnAboutUsFormSubmit').submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('admin.learn-about-us.add')); ?>",
            data: formData,
            cache: false,
            contentType: false,
            processData: false,
    ...
    $('#counterFormSubmit').submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('admin.counter.add')); ?>",
            data: formData,
            cache: false,
            contentType: false,
            processData: false,
    ...
    function addTestimonial(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(route('admin.testimonial.add')); ?>',
            data: formData,
            cache: false,
            contentType: false,
            processData: false,
    ...
    function editTestimonial(id) {
        let route = "<?php echo e(route('admin.testimonial.getbyid', ':id')); ?>";
    ...
    function deleteDestination(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let route = "<?php echo e(route('admin.destination.delete', ':id')); ?>?_token=<?php echo e(csrf_token()); ?>"
                route = route.replace(':id', id);
...
<?php /**PATH /Users/jal/Herd/bookmark/resources/views/admin/destination/js/script.blade.php ENDPATH**/ ?>