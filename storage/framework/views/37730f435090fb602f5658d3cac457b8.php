    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div id="tabs-content">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="myTable-blog" class="table table-bordered mb-3 dt-responsive  nowrap w-100">
                                        ...
                                        <tbody class="blog-result">
                                            <?php echo $__env->make('admin.blog.blogResult', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="myTable-tag" class="table table-bordered mb-3 dt-responsive  nowrap w-100">
                                        ...
                                        <tbody class="tag-result">
                                            <?php echo $__env->make('admin.blog.tagResult', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="myTable-category"
                                        ...
                                        <tbody class="category-result">
                                            <?php echo $__env->make('admin.blog.categoryResult', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                ...
                <?php echo $__env->make('admin.blog.seo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
...
<?php $__env->startSection('js'); ?>
    <?php echo $__env->make('admin.blog.js.datatable', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <script>
    ...
    <script type="text/javascript">
        ...
        function statusChange(id, status) {
            $.ajax({
                ...
                url: "<?php echo e(route('blog.comment.status')); ?>",
                success: function(response) {
        ...
        function deleteBlogComment(e, id = '') {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let route = "<?php echo e(route('blog.comment.delete')); ?>"
                    $.ajax({
                        type: 'POST',
                        url: route,
                        data: {
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/jal/Herd/bookmark/resources/views/admin/blog/index.blade.php ENDPATH**/ ?>