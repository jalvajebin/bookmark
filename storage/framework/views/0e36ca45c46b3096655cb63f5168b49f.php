                        ...
                        <div class="card-body">
                            <form class="formSubmit" data-content=" " id="formSubmit">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-6">
                                            ...
                                            <div class="logo-wrapper mb-4">
                                                <img alt="Logo" src="<?php echo e(asset('admin/images/no-image.png')); ?>"
                                ...
                                <div class="modal-footer p-4">
                                    <a href="<?php echo e(route('services.index')); ?>" style="margin-right: 20px">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/jal/Herd/bookmark/resources/views/admin/destination/create.blade.php ENDPATH**/ ?>