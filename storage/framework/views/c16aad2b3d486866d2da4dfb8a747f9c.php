<script>
        ...
        $(function() {
            datatable = $('#categoryTable').DataTable({
                ...
                searching: true,
                ajax: {
                    url: '<?php echo e(route('jobs.category.getData')); ?>',
                    type: "get",
                    data: function(d) {
        ...
        function dataTable1() {
            $(function() {
                datatable = $('#locationTable').DataTable({
                    ...
                    searching: true,
                    ajax: {
                        url: '<?php echo e(route('jobs.location.getData')); ?>',
                        type: "get",
                        data: function(d) {
        ...
        function dataTable2() {
            $(function() {
                datatable = $('#schoolTypeTable').DataTable({
                    ...
                    searching: true,
                    ajax: {
                        url: '<?php echo e(route('jobs.school-type.getData')); ?>',
                        type: "get",
                        data: function(d) {
        ...
        function dataTable3() {
            $(function() {
                datatable = $('#specialismTable').DataTable({
                    ...
                    searching: true,
                    ajax: {
                        url: '<?php echo e(route('jobs.specialism.getData')); ?>',
                        type: "get",
                        data: function(d) {
        ...
        function dataTable4() {
            $(function() {
                datatable = $('#positionTypeTable').DataTable({
                    ...
                    searching: true,
                    ajax: {
                        url: '<?php echo e(route('jobs.position-type.getData')); ?>',
                        type: "get",
                        data: function(d) {
        ...
        function dataTable5() {
            $(function() {
                datatable = $('#jobTable').DataTable({
                    ...
                    searching: true,
                    ajax: {
                        url: '<?php echo e(route('admin.job.getData')); ?>',
                        type: "get",
                        data: function(d) {
...
<?php /**PATH /Users/jal/Herd/bookmark/resources/views/admin/jobs/js/datatable.blade.php ENDPATH**/ ?>