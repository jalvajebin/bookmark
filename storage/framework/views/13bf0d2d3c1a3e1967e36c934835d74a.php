            ...
            <div class="card">
                <div class="card-body">
                    <form class="bannerFormSubmit" id="bannerFormSubmit">
                        ...
                        <input type="hidden" class="banner_page" name="banner_page" id="banner_page" value="about">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="mb-3">
...
<?php /**PATH /Users/jal/Herd/bookmark/resources/views/admin/about/banner.blade.php ENDPATH**/ ?>