 <script>
    ...
    function previewBanner1(event) {
     ...
     $('#employerContactFormSubmit').submit(function(e) {
         ...
         $.ajax({
             type: 'POST',
             url: "<?php echo e(route('admin.employer-contact.add')); ?>",
             data: formData,
             cache: false,
             contentType: false,
             processData: false,
     ...
     $('#weRecruitForFormSubmit').submit(function(e) {
         ...
         $.ajax({
             type: 'POST',
             url: "<?php echo e(route('admin.we-recruit-for.add')); ?>",
             data: formData,
             cache: false,
             contentType: false,
             processData: false,
...
<?php /**PATH /Users/jal/Herd/bookmark/resources/views/admin/employer/js/script.blade.php ENDPATH**/ ?>