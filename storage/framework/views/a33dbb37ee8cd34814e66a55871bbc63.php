 <script>
     ...
     $('#contactBannerFormSubmit').submit(function(e) {
         ...
         $.ajax({
             type: 'POST',
             url: "<?php echo e(route('admin.banner-contact.add')); ?>",
             data: formData,
             cache: false,
             contentType: false,
             processData: false,
     ...
     $('#whatWedoFormSubmit').on('submit', function(e) {
         ...
         $.ajax({
             type: 'POST',
             url: "<?php echo e(route('storeWhatWeDo')); ?>",
             data: formData,
             cache: false,
             contentType: false,
             processData: false,
     ...
     function addTeam(e) {
         ...
         $.ajax({
             type: 'POST',
             url: '<?php echo e(route('meet-our-team.team.store')); ?>',
             data: formData,
             cache: false,
             contentType: false,
             processData: false,
     ...
     function editTeam(id) {
         let route = "<?php echo e(route('meet-our-team.team.edit', ':id')); ?>";
     ...
     function deleteTeam(id) {
         Swal.fire({
             ...
             if (result.isConfirmed) {
                 let route = "<?php echo e(route('delete-team', ':id')); ?>?_token=<?php echo e(csrf_token()); ?>"
                 route = route.replace(':id', id);
...
<?php /**PATH /Users/jal/Herd/bookmark/resources/views/admin/home/js/script.blade.php ENDPATH**/ ?>