    ...
    function dataTable() {
        $(function() {
            datatable = $('#enquiryTable').DataTable({
                ...
                searching: true,
                ajax: {
                    url: '<?php echo e(route('get.contact.enquiry')); ?>',
                    type: "get",
                    data: function(d) {
    ...
    function dataTable1() {
        $(function() {
            dataTable1 = $('#quoteRequestTable').DataTable({
                ...
                searching: true,
                ajax: {
                    url: '<?php echo e(route('get.request.quote')); ?>',
                    type: "get",
                    data: function(d) {
...
<?php /**PATH /Users/jal/Herd/bookmark/resources/views/admin/contact/js/datatable.blade.php ENDPATH**/ ?>