    ...
    function dataTable() {
        $(function() {
            datatable = $('#careerTable').DataTable({
                ...
                searching: true,
                ajax: {
                    url: '<?php echo e(route('admin.career.getData')); ?>',
                    type: "get",
                    data: function(d) {
     ...
     function dataTable1() {
        $(function() {
            datatable = $('#tagTable').DataTable({
                ...
                searching: true,
                ajax: {
                    url: '<?php echo e(route('admin.tag.getData')); ?>',
                    type: "get",
                    data: function(d) {
...
<?php /**PATH /Users/jal/Herd/bookmark/resources/views/admin/career/js/datatable.blade.php ENDPATH**/ ?>