                        ...
                        <div class="col-sm-12 tbl-res">
                            <div class="top-hd-box mb-3">
                                ...
                                <div class="top-hd-box-right">
                                    <a href="<?php echo e(route('jobs.create')); ?>" class="btn btn-success add-job-btn">Create
                                        New</a>
                                </div>
                            </div>
...
<?php /**PATH /Users/jal/Herd/bookmark/resources/views/admin/jobs/job.blade.php ENDPATH**/ ?>