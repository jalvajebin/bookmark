            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('destination.index')); ?>">destination</a>
                        </li>
                            ...
                            <div class="col-sm-12">
                                <div class="mb-4">
                                    ...
                                    <textarea id="description" name="description" rows="5" class="form-control description"
                                        placeholder="Enter Description"><?php echo e($banner->description); ?></textarea>
...
<?php /**PATH /Users/jal/Herd/bookmark/resources/views/admin/destination/banner.blade.php ENDPATH**/ ?>