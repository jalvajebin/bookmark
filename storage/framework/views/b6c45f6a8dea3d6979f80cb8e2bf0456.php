                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="specialism" id="specialism" class="form-control specialism">
                                                ...
                                                <?php $__currentLoopData = $specialisms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specialism): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($specialism->id); ?>"><?php echo e($specialism->title); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/jal/Herd/bookmark/resources/views/admin/jobs/create.blade.php ENDPATH**/ ?>