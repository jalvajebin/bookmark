<script>
    ...
    function addCategory(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(route('jobs.category.store')); ?>',
            data: formData,
            cache: false,
            contentType: false,
            processData: false,
    ...
    function editCategory(id) {
        let route = "<?php echo e(route('jobs.category.edit', ':id')); ?>";
    ...
    function deleteCategory(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let route = "<?php echo e(route('delete-category', ':id')); ?>?_token=<?php echo e(csrf_token()); ?>"
                route = route.replace(':id', id);
    ...
    function addLocation(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(route('jobs.location.store')); ?>',
            data: formData,
            cache: false,
            contentType: false,
            processData: false,
    ...
    function editLocation(id) {
        let route = "<?php echo e(route('jobs.location.edit', ':id')); ?>";
        route = route.replace(':id', id);
        var formData = new FormData($("locationForm")[0]);
        $.ajax({
            type: 'GET',
    ...
    function deleteLocation(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let route = "<?php echo e(route('delete-location', ':id')); ?>?_token=<?php echo e(csrf_token()); ?>"
                route = route.replace(':id', id);
                formData = new FormData();
                // formData.append('_token', "<?php echo e(csrf_token()); ?>");
                formData.append('id', id);
    ...
    function addSchoolType(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(route('jobs.school-type.store')); ?>',
            data: formData,
            cache: false,
            contentType: false,
            processData: false,
    ...
    function editSchoolType(id) {
        let route = "<?php echo e(route('jobs.school-type.edit', ':id')); ?>";
        route = route.replace(':id', id);
        var formData = new FormData($("schoolTypeForm")[0]);
        $.ajax({
            type: 'GET',
    ...
    function deleteSchoolType(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let route = "<?php echo e(route('delete-school-type', ':id')); ?>?_token=<?php echo e(csrf_token()); ?>"
                route = route.replace(':id', id);
                formData = new FormData();
                // formData.append('_token', "<?php echo e(csrf_token()); ?>");
                formData.append('id', id);
    ...
    function addSpecialism(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(route('jobs.specialism.store')); ?>',
            data: formData,
            cache: false,
            contentType: false,
            processData: false,
    ...
    function editSpecialism(id) {
        let route = "<?php echo e(route('jobs.specialism.edit', ':id')); ?>";
        route = route.replace(':id', id);
        var formData = new FormData($("specialismForm")[0]);
        $.ajax({
            type: 'GET',
    ...
    function deleteSpecialism(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let route = "<?php echo e(route('delete-specialism', ':id')); ?>?_token=<?php echo e(csrf_token()); ?>"
                route = route.replace(':id', id);
                formData = new FormData();
                // formData.append('_token', "<?php echo e(csrf_token()); ?>");
                formData.append('id', id);
    ...
    function addPositionType(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(route('jobs.position-type.store')); ?>',
            data: formData,
            cache: false,
            contentType: false,
            processData: false,
    ...
    function editPositionType(id) {
        let route = "<?php echo e(route('jobs.position-type.edit', ':id')); ?>";
        route = route.replace(':id', id);
        var formData = new FormData($("positionTypeForm")[0]);
        $.ajax({
            type: 'GET',
    ...
    function deletePositionType(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let route = "<?php echo e(route('delete-position-type', ':id')); ?>?_token=<?php echo e(csrf_token()); ?>"
                route = route.replace(':id', id);
                formData = new FormData();
                // formData.append('_token', "<?php echo e(csrf_token()); ?>");
                formData.append('id', id);
...
<?php /**PATH /Users/jal/Herd/bookmark/resources/views/admin/jobs/js/script.blade.php ENDPATH**/ ?>