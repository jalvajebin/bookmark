            ...
            <div class="card">
                <div class="card-body">
                    <form class="aboutUsFormSubmit" id="aboutUsFormSubmit">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="about_us_id" id="about_us_id" value="<?php echo e($aboutUs->id ?? ''); ?>">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    <label for="title">Title</label>
                                    <input id="title" name="title" type="text" class="form-control title"
                                        placeholder="Title" value="<?php echo e($aboutUs->title ?? ''); ?>">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <textarea id="description" name="description" rows="5" class="form-control description"
                                        placeholder="Enter Description"><?php echo e($aboutUs->description ?? ''); ?></textarea>
                            ...
                            <div class="col-sm-6 col-md-6 col-6">
                                ...
                                <div class="logo-wrapper mb-3">
                                    <img alt="Image1"
                                        src="<?php echo e(optional($aboutUs)->images->url ?? asset('admin/images/no-image.png')); ?>"
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input id="image1_alt" name="image1_alt" type="text" class="form-control"
                                    value="<?php echo e(optional($aboutUs)->image1_alt ?? ''); ?>" placeholder="Enter alt">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="mb-4">
                                ...
                                <input id="online_support_no" name="online_support_no" type="text"
                                    ...
                                    value="<?php echo e(optional($aboutUs)->online_support_number ?? ''); ?>">
...
<?php /**PATH /Users/jal/Herd/bookmark/resources/views/admin/about/about-us.blade.php ENDPATH**/ ?>