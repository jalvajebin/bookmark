                ...
                <div class="card-body">
                    <form id="whatWedoFormSubmit" enctype="multipart/form-data">
                        ...
                        <input type ="hidden" id ="what_we_do_id" name="what_we_do_id" class="what_we_do_id"
                            value="<?php echo e(optional($whatWedo)->id); ?>">
                        <!-- Type -->
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="Enter title"
                                value="<?php echo e(optional($whatWedo)->title); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" class="form-control" placeholder="Enter Description"><?php echo e(optional($whatWedo)->description); ?></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="logo-wrapper">
                                <img alt="Logo"
                                    src="<?php echo e($whatWedo->WhatImages['preview'] ?? asset('admin/images/no-image.png')); ?>"
                        ...
                        <div id="easyStepFields">
                            <div class="mb-3">
                                ...
                                <input type="text" name="title_one" placeholder="Enter Title" class="form-control"
                                    value="<?php echo e(optional($whatWedo)->title_one); ?>">
                            </div>
                            <div class="mb-3">
                                <label>Paragraph One</label>
                                <textarea name="para_one" placeholder="Enter Description" class="form-control"><?php echo e(optional($whatWedo)->para_one); ?></textarea>
                            </div>
                            <div class="mb-3">
                                <label>Title Two</label>
                                <input type="text" name="title_two" placeholder="Enter Title" class="form-control"
                                    value="<?php echo e(optional($whatWedo)->title_two); ?>">
                            </div>
                            <div class="mb-3">
                                <label>Paragraph Two</label>
                                <textarea name="para_two" placeholder="Enter Description" class="form-control"><?php echo e(optional($whatWedo)->para_two); ?></textarea>
                            </div>
                            <div class="mb-3">
                                <label>Title Three</label>
                                <input type="text" placeholder="Enter Title" name="title_three" class="form-control"
                                    value="<?php echo e(optional($whatWedo)->title_three); ?>">
                            </div>
                            <div class="mb-3">
                                <label>Paragraph Three</label>
                                <textarea name="para_three" placeholder="Enter Description" class="form-control"><?php echo e(optional($whatWedo)->para_three); ?></textarea>
                            </div>
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="<?php echo e(route('whatwedo.index')); ?>" class="btn btn-secondary me-2">Cancel</a>
...
<?php /**PATH /Users/jal/Herd/bookmark/resources/views/admin/home/what-we-do.blade.php ENDPATH**/ ?>