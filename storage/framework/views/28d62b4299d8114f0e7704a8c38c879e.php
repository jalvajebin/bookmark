            ...
            <div class="card">
                <div class="card-body">
                    <form class="bannerFormSubmit" id="bannerFormSubmit">
                        ...
                        <input type="hidden" class="banner_page" name="banner_page" id="banner_page" value="employer">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="mb-3">
                            ...
                            <div class="col-sm-12">
                                <div class="mb-4">
                                    ...
                                    <textarea id="description" name="description" rows="5" class="form-control description"
                                        placeholder="Enter Description"><?php echo e(optional($banner)->description); ?>
                            ...
                            <div class="col-sm-12 col-12">
                                ...
                                <div class="logo-wrapper">
                                    <img alt="Logo"
                                        src="<?php echo e($banner->images->preview ?? asset('admin/images/no-image.png')); ?>"
                                ...
                                <div class="mb-4 mt-3">
                                    ...
                                    <input name="banner_alt" type="text" value="<?php echo e($banner->alt ?? ''); ?>"
...
<?php /**PATH /Users/jal/Herd/bookmark/resources/views/admin/employer/banner.blade.php ENDPATH**/ ?>