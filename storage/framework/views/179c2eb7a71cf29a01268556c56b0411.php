     ...
     function deleteTestimonial(id) {
         Swal.fire({
             ...
             if (result.isConfirmed) {
                 let route = "<?php echo e(route('admin.testimonial.delete', ':id')); ?>?_token=<?php echo e(csrf_token()); ?>"
                 route = route.replace(':id', id);
...
<?php /**PATH /Users/jal/Herd/bookmark/resources/views/admin/about/js/script.blade.php ENDPATH**/ ?>