<script>
    ...
    function deleteContactEnquiry(e, id = '') {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let route = "<?php echo e(route('contact.enquiry.delete')); ?>"
                $.ajax({
                    type: 'POST',
                    url: route,
                    data: {
    ...
    function deleteQuoteRequest(e, id = '') {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let route = "<?php echo e(route('quote.request.delete')); ?>"
                $.ajax({
                    type: 'POST',
                    url: route,
                    data: {
    ...
    function exportSelect(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('contacts.export')); ?>",
            type: 'post',
            data: {
                ids: ids,
                _token: "<?php echo e(csrf_token()); ?>",
    ...
    function exportQuoteSelect(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('quote.export')); ?>",
            type: 'post',
            data: {
                ids: ids,
                _token: "<?php echo e(csrf_token()); ?>",
    ...
    function viewRequestQuote(value, id) {
        ...
        if (value == 1) {
            ...
            let route = "<?php echo e(route('admin.quote.getbyid', ':id')); ?>";
...
<?php /**PATH /Users/jal/Herd/bookmark/resources/views/admin/contact/js/script.blade.php ENDPATH**/ ?>