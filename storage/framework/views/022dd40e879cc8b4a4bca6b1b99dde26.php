<script>
    ...
    function deleteCareer(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let route = "<?php echo e(route('admin.career.delete', ':id')); ?>?_token=<?php echo e(csrf_token()); ?>"
    ...
    function addtag(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(route('career.tag.store')); ?>',
            data: formData,
            cache: false,
            contentType: false,
            processData: false,
    ...
    function edittag(id) {
        let route = "<?php echo e(route('career.tag.edit', ':id')); ?>";
        route = route.replace(':id', id);
        var formData = new FormData($("tagForm")[0]);
        $.ajax({
            type: 'GET',
    ...
    function deletetag(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let route = "<?php echo e(route('delete-tag', ':id')); ?>?_token=<?php echo e(csrf_token()); ?>"
                route = route.replace(':id', id);
                formData = new FormData();
                // formData.append('_token', "<?php echo e(csrf_token()); ?>");
                formData.append('id', id);
...
<?php /**PATH /Users/jal/Herd/bookmark/resources/views/admin/career/js/script.blade.php ENDPATH**/ ?>